...
\hspace{-0.1cm}\cvitem{\textbf{Ph.D. Supervisors}}{Prof. Owen Arden \& Prof. Ioannis Demertzis}
...
%\begin{itemize}
\hspace{-0.1cm}\cvitem{\textbf{Programming skills}} {C, C++, Java, Haskell, Coq, Dafny, HTML, CSS, Python, JavaScript}
\hspace{-0.1cm}\cvitem{\textbf{Technical skills}}{Linux, Git, \LaTeX, GDB, Wireshark, OpenSSL, SQL, Matlab, Docker, Django}
